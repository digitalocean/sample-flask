...
def informeQualityShop():
    ...
    enviar_correo(["qualityshopargentina@gmail.com","josudavidg@gmail.com","acciaiomatiassebastian@gmail.com","mmsjuancarrillo@gmail.com","nj.11@hotmail.com"],f"Informe de envios {fecha.day}-{fecha.month}-{fecha.year} {(fecha.hour)-3}hs","informe.xlsx","informe.xlsx"," ")