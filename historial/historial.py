...
columnas = """ H.Fecha, H.Hora, H.id, H.Numero_envío,V.Telefono,H.Direccion_completa,vendedor(H.Vendedor),H.Localidad,H.Chofer,
                H.estado_envio,H.motivo_noenvio,H.Precio,H.Costo,H.Currentlocation,H.Correo_chofer,H.Foto_domicilio,V.Cobrar,V.columna_1,V.columna_2,V.columna_3"""
...
def busqueda():
    ...
    if busqueda.lower() == "entregadoduplicado":
        ...
        sql = f"select {columnas} from historial_estados as H where H.estado_envio = 'Levantada' {order}"
