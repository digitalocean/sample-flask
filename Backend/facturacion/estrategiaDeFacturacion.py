    ...
    def facturar_viajes(self, viajes,sobreEscribe=False):
        ...
        for viaje in viajes:
            if viaje.estado_envio in ["Entregado"] or viaje.motivo in ["Nadie en domicilio", "Rechazado"]:
                ...
                informacion_viaje = (viaje.Fecha, viaje.Numero_envío, viaje.Direccion, viaje.Localidad, precio, viaje.comprador,cobrar,viaje.valorDeclarado, viaje.estado_envio)
