from Backend.descargaLogixs.downloadSpreedSheets import cargaCamargo,cargaformatoMMS,cargaCamargoMe1,cargaRobotin
from Backend.descargaLogixs.descargaLogixs import descargaLogixs
...
def informeEstados(vendedor):
    ...
    enviar_correo([correoVendedor,"josudavidg@gmail.com","mmsjuancarrillo@gmail.com","njb.11@hotmail.com"],f"Informe de envios {vendedor} {fecha.day}-{fecha.month}-{fecha.year} {(fecha.hour)}hs","descargas/informe.xlsx","informe.xlsx"," ")
