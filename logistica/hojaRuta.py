...
def hojaDeRuta():
    if request.method == "POST":
        ...
        sql = f"select Numero_envío, Direccion, Localidad, Referencia,Vendedor From ViajesFlexs where Chofer = '{chofer}' and Numero_envío in (select Numero_envío from historial_estados where Fecha = '{fecha}' and estado_envio in ('En Camino', 'Reasignado'))"
